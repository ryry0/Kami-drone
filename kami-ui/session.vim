...
set mouse=a
set pastetoggle=<F2>
set path=/mnt/c/Users/Ryan/Desktop/Workspace/hybrid_frontend/**
set ruler
...
silent only
cd /mnt/c/Users/Ryan/Desktop/Workspace/hybrid_frontend
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 mvu.c
badd +125 nk_utility.h
badd +3 nk_utility.c
badd +145 tools/algo/packet_hybrid.h
badd +888 ../nuklear/nuklear.h
badd +650 ../nuklear/demo/overview.c
badd +45 record.c
args mvu.c
edit mvu.c
...
silent! normal! zE
let s:l = 89 - ((11 * winheight(0) + 31) / 63)
...
wincmd w
argglobal
edit tools/algo/packet_hybrid.h
iabbr <buffer> <silent> incl =MapNoContext(' incl', '#include \<\>\<Left\>\<C-R\>=Eatchar()\<CR\>')
iabbr <buffer> <silent> defi =MapNoContext(' defi', '#define \<C-R\>=Eatchar()\<CR\>')
iabbr <buffer> <silent> fori =MapNoContext(' fori', 'for (int i = 0; i \<; ++i) {\<CR\>\<CR\>}\<UP\>\<UP\>\<ESC\>0f\<a \<C-R\>=Eatchar()\<CR\>')
iabbr <buffer> <silent> foru =MapNoContext(' foru', 'for (unsigned int i = 0; i \<; ++i) {\<CR\>\<CR\>}\<UP\>\<UP\>\<ESC\>0f\<a \<C-R\>=Eatchar()\<CR\>')
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 30 - ((29 * winheight(0) + 31) / 63)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
30
